...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { cpf: @paciente.cpf, data_nasc: @paciente.data_nasc, email: @paciente.email, endereco: @paciente.endereco, nome: @paciente.nome, rg: @paciente.rg, senha: @paciente.senha, telefone: @paciente.telefone } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { cpf: @paciente.cpf, data_nasc: @paciente.data_nasc, email: @paciente.email, endereco: @paciente.endereco, nome: @paciente.nome, rg: @paciente.rg, senha: @paciente.senha, telefone: @paciente.telefone } }
