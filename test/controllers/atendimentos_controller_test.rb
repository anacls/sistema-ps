...
class AtendimentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atendimento" do
    assert_difference('Atendimento.count') do
      post atendimentos_url, params: { atendimento: { sintomas: @atendimento.sintomas, situacao: @atendimento.situacao, tempoChegada: @atendimento.tempoChegada, tipoAtendimento: @atendimento.tipoAtendimento } }
    end
  ...
  test "should update atendimento" do
    patch atendimento_url(@atendimento), params: { atendimento: { sintomas: @atendimento.sintomas, situacao: @atendimento.situacao, tempoChegada: @atendimento.tempoChegada, tipoAtendimento: @atendimento.tipoAtendimento } }
