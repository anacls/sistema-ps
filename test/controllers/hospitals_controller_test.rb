...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { cnpj: @hospital.cnpj, email: @hospital.email, endereco: @hospital.endereco, nome: @hospital.nome, senha: @hospital.senha, telefone: @hospital.telefone } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { cnpj: @hospital.cnpj, email: @hospital.email, endereco: @hospital.endereco, nome: @hospital.nome, senha: @hospital.senha, telefone: @hospital.telefone } }
